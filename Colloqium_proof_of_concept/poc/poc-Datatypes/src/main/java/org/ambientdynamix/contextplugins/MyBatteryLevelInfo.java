...
class MyBatteryLevelInfo implements IMyBatteryLevelInfo {
	/**
	 ...
	 */
	public static Parcelable.Creator<MyBatteryLevelInfo> CREATOR = new Parcelable.Creator<MyBatteryLevelInfo>() {
		/**
		 ...
		 */
		public MyBatteryLevelInfo createFromParcel(Parcel in) {
			return new MyBatteryLevelInfo(in);
		}

		/**
		 * Create a new array of the Parcelable class.
		 */
		public MyBatteryLevelInfo[] newArray(int size) {
			return new MyBatteryLevelInfo[size];
		}
	};
	// Public static variable for our supported context type
	public static String CONTEXT_TYPE = "org.ambientdynamix.contextplugins.mybatterylevel";
	// Private data
	 ...
	 */
	public MyBatteryLevelInfo(Intent intent) {
	 ...
	 */
	private MyBatteryLevelInfo(final Parcel in) {
